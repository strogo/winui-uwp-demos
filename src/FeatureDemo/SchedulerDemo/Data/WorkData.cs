...
namespace SchedulerDemo {
    ...
    public static class WorkData {
        ...
        static void LoadFromXml() {
            XDocument document = LoadFromXmlResource("Data/SchedulerDemoData/Employees.xml");
            if(document != null) {
            ...
            document = LoadFromXmlResource("Data/SchedulerDemoData/Customers.xml");
            if(document != null) {
        ...
        static WorkAppointment FridayParty(DateTime start) {
            ...
            var appt = new WorkAppointment() {
                ...
                Label = LabelNone.Id,
                Location = WorkDataStrings.AptLoc_ConferenceRoom,
                //ResourceId = GetAllResourceIds().First(),
            };
